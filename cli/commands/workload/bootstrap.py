...
@click.option('--workload-gitops-template-branch', '-wgb', 'wl_gitops_template_branch',
              ...
              type=click.STRING)
def bootstrap(wl_repo_name: str, wl_gitops_repo_name: str, wl_template_url: str, wl_template_branch: str,
              wl_gitops_template_url: str, wl_gitops_template_branch: str):
    """Bootstraps workload repository with template."""
    click.echo("Bootstrap workload.")
