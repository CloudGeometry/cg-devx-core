...
from common.const.const import WL_GITOPS_REPOSITORY_URL, WL_REPOSITORY_BRANCH
...
class WorkloadManager:
    ...
    def __init__(
        ...
        self._url = template_url or WL_GITOPS_REPOSITORY_URL
        self._branch = template_branch or WL_REPOSITORY_BRANCH
        self._git_org_name = org_name
        self.repo_name = repo_name
        self.key_path = key_path
        self.wl_repo_folder = LOCAL_WORKLOAD_TEMP_FOLDER / repo_name
        self.template_repo_folder = LOCAL_WORKLOAD_TEMP_FOLDER / GHRepo.parse(template_url).name
        self.wl_repo = None
    ...
    def clone_wl(self) -> None:
        ...
        self.wl_repo = self._clone_repository(url=wl_repo_url, branch=self._branch, folder=self.wl_repo_folder)
    ...
    def _clone_repository(self, url: str, branch: str, folder: Union[str, Path]) -> Repo:
        """
