    ...
    "Statement" : [
      {
        ...
        "Effect" : "Allow",
        "Resource" : "arn:aws:ecr:${var.aws_region}:${var.aws_account}:*"
      }
    ]
  })
  tags = local.tags
    ...
    "Statement" : [
      {
        "Action" : "eks:*",
        "Effect" : "Allow",
        "Resource" : "arn:aws:eks:${var.aws_region}:${var.aws_account}:*"
      }
    ]
  })
    ...
    "Statement" : [
      {
        ...
        "Effect" : "Allow",
        "Resource" : "arn:aws:secretsmanager:${var.aws_region}:${var.aws_account}:*"
      }
    ]
  })
